...
function enhance(){const start=$('#start');if(start&&!start.dataset.v2){start.dataset.v2='1';const text=start.textContent.trim();start.innerHTML=`<span class="zsl-v2-cta">${text}</span>`}sync()}
