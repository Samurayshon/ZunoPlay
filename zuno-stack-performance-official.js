...
function loadFeel(){if(!document.querySelector('link[data-zso-feel]')){const l=document.createElement('link');l.rel='stylesheet';l.href='zuno-stack-feel-official.css?v=f1f960a';l.dataset.zsoFeel='1';document.head.appendChild(l)}if(!document.querySelector('script[data-zso-feel]')){const s=document.createElement('script');s.src='zuno-stack-feel-official.js?v=c6b2c5e';s.defer=true;s.dataset.zsoFeel='1';document.head.appendChild(s)}}
loadFeel();
