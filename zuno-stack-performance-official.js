...
if(mobile)document.documentElement.classList.add('zso-mobile-lite');
const style=document.createElement('style');style.textContent=`
.zso-lite .tile.active .zsp-art,.zso-mobile-lite .tile.active .zsp-art{box-shadow:inset 0 1px #ffffff55,0 3px 0 #070713!important}
.zso-lite .board,.zso-mobile-lite .board{box-shadow:inset 0 0 28px #7c39d510!important}
.zso-lite .zso-powers button>span,.zso-mobile-lite .zso-powers button>span{box-shadow:0 0 6px #9d34ff33!important}
.zso-lite[data-zsr-pressure="critical"] .board,.zso-mobile-lite[data-zsr-pressure="critical"] .board{animation:none!important;box-shadow:inset 0 0 34px #8b315f1c!important}
.zso-mobile-lite .zsf-spark,.zso-mobile-lite .zsr-banner:before,.zso-mobile-lite .zsr-banner:after{display:none!important}
.zso-mobile-lite .zsf-flight{filter:none!important}
.zso-mobile-lite .zsp-art,.zso-mobile-lite .tile{will-change:auto!important}
.zso-paused *{animation-play-state:paused!important}`;document.head.appendChild(style);
...
loadJs('zuno-stack-feel-official.js?v=a58ba9a','zsoFeel');
...
loadJs('zuno-stack-pressure-official.js?v=77b4179','zsoPressure');
