...
function loadFeel(){if(!document.querySelector('link[data-zso-feel]')){const l=document.createElement('link');l.rel='stylesheet';l.href='zuno-stack-feel-official.css?v=eaa947d';l.dataset.zsoFeel='1';document.head.appendChild(l)}if(!document.querySelector('script[data-zso-feel]')){const s=document.createElement('script');s.src='zuno-stack-feel-official.js?v=3ad75e7';s.defer=true;s.dataset.zsoFeel='1';document.head.appendChild(s)}}
loadFeel();
