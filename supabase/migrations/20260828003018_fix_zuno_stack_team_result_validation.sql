...
begin
  ...
  -- Zuno Stack é cooperativo: um parceiro pode concluir o tabuleiro antes
  -- de o jogador limpar 9 peças. Por isso vitória não pode depender desse mínimo local.
...
revoke all on function public.submit_zuno_stack_result(integer,integer,integer,boolean) from public, anon;
grant execute on function public.submit_zuno_stack_result(integer,integer,integer,boolean) to authenticated, service_role;
