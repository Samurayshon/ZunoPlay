create unique index if not exists conversation_members_one_owner_per_conversation_idx
on public.conversation_members (conversation_id)
where role = 'owner';

create or replace function zuno_private.zuno_group_transfer_owner(
