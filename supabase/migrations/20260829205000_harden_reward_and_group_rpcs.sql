-- ZunoPlay QA/Security: close two confirmed privileged RPC integrity gaps.
-- 1) Treat the two legacy room reward RPC names as one daily reward budget.
-- 2) Prevent the group-member removal RPC from mutating direct conversations.
