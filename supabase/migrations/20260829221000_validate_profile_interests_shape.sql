...
-- Keep profile interests structurally consistent with the existing model:
-- the column defaults to [] and all production values are arrays of strings.
-- Do not invent a product-specific item-count limit here.
