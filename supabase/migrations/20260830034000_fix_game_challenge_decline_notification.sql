-- Keep challenge status vocabulary and notification state vocabulary aligned.
-- game_challenges uses `declined`, while notifications intentionally render the
-- corresponding action state/type as `rejected` / `game_challenge_rejected`.
