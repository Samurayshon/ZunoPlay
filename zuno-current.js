(()=>{
  ...
  function installRefresh(){if(!('serviceWorker' in navigator))return;const key='zuno-sw-v247-reloaded';navigator.serviceWorker.addEventListener('controllerchange',()=>{if(sessionStorage.getItem(key)==='1')return;sessionStorage.setItem(key,'1');location.reload()})}
