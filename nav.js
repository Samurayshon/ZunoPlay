(()=>{
  if(window.__ZUNOPLAY_GLOBAL_BOOT_V194__)return;
  window.__ZUNOPLAY_GLOBAL_BOOT_V194__=true;
  ...
  if(page==='sala.html'){
    ...
    loadScript('zunoplay-room-connection-fix','./zuno-room-connection-fix.js');
