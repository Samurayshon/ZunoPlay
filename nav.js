(()=>{
if(window.__ZUNOPLAY_GLOBAL_BOOT_V195__)return;window.__ZUNOPLAY_GLOBAL_BOOT_V195__=true;
const V='195',page=(location.pathname.split('/').pop()||'index.html').toLowerCase(),home=page==='index.html',pub=new Set(['login.html','cadastro.html']),social=['amigos.html','conversas.html','comunidades.html','perfil.html','notificacoes.html'],profile=['perfil.html','avatar.html'],rooms=['salas.html','sala.html'],games=['jogos.html','historico.html','zuno-core.html','zuno-stack.html'],roomGames=['zuno-core.html','zuno-stack.html'];
...
if(page==='sala.html'){
 ...
 js('zunoplay-realtime-global','./realtime-global.js',()=>{js('zunoplay-room-session-guard','./room-session-guard.js');js('zunoplay-room-connection-fix','./zuno-room-connection-fix.js');js('zunoplay-room-experience-stage5','./zuno-room-experience.js');js('zunoplay-room-voice','./voz-sala.js')});
