(() => {
  ...
  function isHomeCandidate(el) {
    ...
    // Conversas used .back for the home icon; sala.html uses .back for a real back action and must stay intact.
  ...
  function ensureSingleHome() {
    ...
    // After dynamic rendering, any newly-created duplicate is removed immediately.
    const current = [...document.querySelectorAll('.zunoplay-home-button')];
  ...
  const observer = new MutationObserver(() => ensureSingleHome());
