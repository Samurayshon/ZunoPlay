(()=>{
if(window.__ZUNOPLAY_GLOBAL_BOOT_V209__)return;window.__ZUNOPLAY_GLOBAL_BOOT_V209__=true;
const V='209',page=(location.pathname.split('/').pop()||'index.html').toLowerCase(),home=page==='index.html',pub=new Set(['login.html','cadastro.html']),social=['amigos.html','conversas.html','comunidades.html','perfil.html','notificacoes.html'],profile=['perfil.html','avatar.html'],rooms=['salas.html','sala.html'],games=['jogos.html','historico.html','zuno-stack.html'],roomGames=['zuno-stack.html'];
