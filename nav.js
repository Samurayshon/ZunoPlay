(() => {
  ...
  function loadOfficialAvatars(){
    loadScript('zunoplay-official-avatars-v38','./official-avatars.js?v=38','ZunoPlay: não foi possível carregar os avatares oficiais');
  }

  function loadOfficialHome(){
    if(page!=='index.html')return;
    loadStyle('zunoplay-home-v38-style','./home-v29.css?v=38');
    loadScript('zunoplay-home-v38-script','./home-v29.js?v=38','ZunoPlay: não foi possível carregar a Home oficial');
  }
