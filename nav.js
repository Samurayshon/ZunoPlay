(()=>{
if(window.__ZUNOPLAY_GLOBAL_BOOT_V196__)return;window.__ZUNOPLAY_GLOBAL_BOOT_V196__=true;
const V='196',page=(location.pathname.split('/').pop()||'index.html').toLowerCase(),home=page==='index.html',pub=new Set(['login.html','cadastro.html']),social=['amigos.html','conversas.html','comunidades.html','perfil.html','notificacoes.html'],profile=['perfil.html','avatar.html'],rooms=['salas.html','sala.html'],games=['jogos.html','historico.html','zuno-core.html','zuno-stack.html'],roomGames=['zuno-core.html','zuno-stack.html'];
...
/* Um único cliente Supabase por página. O CDN já foi carregado antes de nav.js em sala.html. */
if(window.supabase?.createClient&&!window.ZunoSupabaseClient){try{window.ZunoSupabaseClient=window.supabase.createClient('https://rliymfbbhqoejgfvsbuu.supabase.co','sb_publishable_E4go4X7yZ6d-aXnKAT-fWw_Y8uHIJT0',{auth:{persistSession:true,autoRefreshToken:true,detectSessionInUrl:true}})}catch(e){console.error('ZunoPlay: Supabase bootstrap',e)}}
...
if(page==='sala.html'){
 ...
 /* O bootstrap funcional não depende do Realtime: banco primeiro, realtime depois. */
