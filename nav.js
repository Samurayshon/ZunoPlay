(()=>{
if(window.__ZUNOPLAY_GLOBAL_BOOT_V222__)return;window.__ZUNOPLAY_GLOBAL_BOOT_V222__=true;
const V='222',page=(location.pathname.split('/').pop()||'index.html').toLowerCase(),home=page==='index.html',pub=new Set(['login.html','cadastro.html']),social=['amigos.html','conversas.html','comunidades.html','perfil.html','notificacoes.html'],profile=['perfil.html','avatar.html'],rooms=['salas.html','sala.html'],games=['jogos.html','historico.html','zuno-stack.html'],roomGames=['zuno-stack.html'];
...
if(page==='zuno-stack.html'){css('zunoplay-stack-premium-style','./zuno-stack-premium.css');js('zunoplay-stack-performance','./zuno-stack-performance.js');js('zunoplay-stack-premium','./zuno-stack-premium.js');js('zunoplay-stack-social','./zuno-stack-social.js');js('zunoplay-stack-progression','./zuno-stack-progression.js')}
