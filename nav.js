(()=>{
  if(window.__ZUNOPLAY_GLOBAL_BOOT_V186__)return;
  window.__ZUNOPLAY_GLOBAL_BOOT_V186__=true;

  /*
   * ZunoPlay UI — Etapa 3/8
   * Home aprovada permanece intacta.
   * Páginas secundárias usam chrome global + componentes visuais reutilizáveis.
   */
  const V='186';
  ...
  /* Camada final de componentes: vence estilos legados de conteúdo sem alterar a Home. */
